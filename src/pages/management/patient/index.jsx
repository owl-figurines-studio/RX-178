...
import { AtTag, AtModal, AtActivityIndicator } from 'taro-ui'
...
@connect(({ user, loading }) => {
  ...
  return {
    patientInfo,
    userPhone,
    queryPatientLoading: loading.effects['user/queryPatient'],
    updatePatientLoading: loading.effects['user/updatePatient']
  }
})
class Patient extends Component {
  ...
  render() {
    ...
    const { queryPatientLoading, updatePatientLoading } = this.props
    ...
    return (
      <BasicPage navBarProps={navBarProps} >
        ...
        <View>
          {
            queryPatientLoading || updatePatientLoading ? (
